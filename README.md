...
A token is saved to localStorage as a method of client-side authentication
...
Web servers use HTTP to transfer web files to a computer based on the requests from their HTTP client
